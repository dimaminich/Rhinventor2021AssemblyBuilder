...
namespace Rhinventor2021AssemblyBuilder
{
    class InventorAssemblySession
    {
        ...
        public AssemblyDocument openAssemblyDocument(string instance)
        {
            AssemblyDocument assemblyDocument = (AssemblyDocument)inventorApplication.Documents.Open(instance);
        ...
        public void transformComponent(AssemblyDocument assemblyDocument, ChildComponent childComponent)
        {
            manipulateParameter(assemblyDocument, childComponent);
            manipulatePointPosition(assemblyDocument, childComponent);
            manipulateIProperties(assemblyDocument, childComponent);
            assemblyDocument.Update();
            inventorApplication.CommandManager.ControlDefinitions["AppZoomallCmd"].Execute();
        }
        ...
        private void manipulateParameter(AssemblyDocument assemblyDocument, ChildComponent childComponent)
        {
            string _sketch3dName;
            Inventor.PartComponentDefinition subComponentDef = getSubpartDefinition(assemblyDocument, childComponent, out _sketch3dName);
            ...
            foreach (Inventor.UserParameter inventorUserParameter in inventorUserParameters)
            {
                ...
                try
                {
                    childParameter = childComponent.parameterData[inventorUserParameter.Name];
        ...
        private void manipulatePointPosition(AssemblyDocument assemblyDocument, ChildComponent childComponent)
        {
            string sketch3dName;
            Inventor.PartComponentDefinition subComponentDef = getSubpartDefinition(assemblyDocument, childComponent, out sketch3dName);
        ...
        private void manipulateIProperties(AssemblyDocument assemblyDocument, ChildComponent childComponent)
        {
            recursiveSetIProperty((Document)assemblyDocument, childComponent.ipropertyData);
            setIProperty((Document)assemblyDocument, childComponent.ipropertyData);
        }
        ...
        private Inventor.PartComponentDefinition getSubpartDefinition(AssemblyDocument assemblyDocument, ChildComponent childComponent, out string sketch3dName)
        {
            ...
            try
            {
                Inventor.ComponentOccurrence subComponent = assemblyDocument.ComponentDefinition.Occurrences.ItemByName[fullpartname];
        ...
        public void exportToRevitFamily(AssemblyDocument assemblyDocument, string instance)
        {
